 ...
 * @param
 */
public class My_Directed_Weighted_Graph_Algorithms implements DirectedWeightedGraphAlgorithms {
    ...
    public DirectedWeightedGraph copy() {
        DirectedWeightedGraph new_graph = new My_DirectedWeightedGraph();
        Iterator<NodeData> iterNode = graph.nodeIter();
        while (iterNode.hasNext()) {
            My_NodeData node = (My_NodeData)iterNode.next();
            NodeData new_node = new My_NodeData(node);
